...
# COMPLETION_WAITING_DOTS="%F{yellow}waiting...%f" Caution: this setting can
# cause issues with multiline prompts in zsh < 5.7.1 (see #5765)
...
if [[ -n $SSH_CONNECTION ]]; then export EDITOR='vim' else export EDITOR='nvim';export VISUAL='nvim'
fi
...
# to define aliases within a top-level file in the $ZSH_CUSTOM folder, with
# .zsh extension. Examples: - $ZSH_CUSTOM/aliases.zsh - $ZSH_CUSTOM/macos.zsh
